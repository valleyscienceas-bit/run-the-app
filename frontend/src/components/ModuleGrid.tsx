    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {modules.map((module, index) => (
        <motion.div
          ...
          className="group relative bg-white border-2 border-slate-100 rounded-[40px] p-8 hover:shadow-2xl hover:border-soft-pink transition-all cursor-pointer overflow-hidden"
        >
          ...
          <h3 className="text-2xl font-black text-slate-900 mb-3 group-hover:text-soft-pink transition-colors relative z-10">
            {module.title}
          </h3>
          
          <p className="text-sm text-slate-500 font-medium mb-8 line-clamp-2 relative z-10 leading-relaxed">
            {module.description}
          </p>
