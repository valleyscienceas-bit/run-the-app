 ...
 * (mirrors /api/update-assignment-progress).
 */
export function computeNextAssignmentSubmission(input: AssignmentProgressInput): AssignmentSubmission {
  ...
  let status: AssignmentSubmission['status'] = prev.status || 'not_started';
